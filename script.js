...
function tampilkanCerita() {
  ...
  if (cerita[provinsi]) {
    ...
    gambarElem.style.display = "block";   // tampilkan gambar

    isiElem.innerHTML = cerita[provinsi].isi; // PENTING!
  } else {
    judulElem.textContent = "Cerita belum tersedia 😅";
    gambarElem.src = "";
    gambarElem.style.display = "none";   // sembunyikan gambar
    isiElem.innerHTML = "";
  }
}